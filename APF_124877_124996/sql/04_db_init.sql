...
BEGIN
    ...
    ('testadmin', 'test123', 'Test Administrator'),
    
    -- 1. Alpine
    ('pgasly', 'alpine2025', 'Pierre Gasly'),
('fcolapinto', 'alpine2025', 'Franco Colapinto'),
('jdoohan', 'alpine2025', 'Jack Doohan'),
('paron', 'alpine2025', 'Paul Aron'),
('kmaini', 'alpine2025', 'Kush Maini'),
('fbriatore', 'alpine2025', 'Flavio Briatore'),
('dsanchez', 'alpine2025', 'David Sanchez'),
-- 2. Aston Martin
('falonso', 'aston2025', 'Fernando Alonso'),
('lstroll', 'aston2025 ', 'Lance Stroll'),
('svandoorne', 'aston2025', 'Stoffel Vandoorne'),
('acowell', 'aston2025', 'Andy Cowell'),
('ecardile', 'aston2025', 'Enrico Cardile'),

-- 3. Ferrari
('cleclerc', 'ferrari2025', 'Charles Leclerc'),
('lhamilton', 'ferrari2025', 'Lewis Hamilton'),
('zguanyu', 'ferrari2025', 'Zhou Guanyu'),
('agiovinazzi', 'ferrari2025', 'Antonio Giovinazzi'),
('fvasseur', 'ferrari2025', 'Frédéric Vasseur'),
('lserra', 'ferrari2025', 'Loic Serra'),
('egualtieri', 'ferrari2025', 'Enrico Gualtieri'),

-- 4. Red Bull Racing
('mverstappen', 'redbull2025', 'Max Verstappen'),
('ytsunoda', 'redbull2025', 'Yuki Tsunoda'),
('lmekies', 'redbull2025', 'Laurent Mekies'),
('pwache', 'redbull2025', 'Pierre Waché'),

-- 5. Mercedes-AMG
('grussell', 'merc2025', 'George Russell'),
('kantonelli', 'merc2025', 'Kimi Antonelli'),
('vbottas', 'merc2025', 'Valtteri Bottas'),
('fvesti', 'merc2025', 'Frederik Vesti'),
('twolff', 'merc2025', 'Toto Wolff'),
('jallison', 'merc2025', 'James Allison'),
-- 6. McLaren
('lnorris', 'mclaren2025', 'Lando Norris'),
('opiastri', 'mclaren2025', 'Oscar Piastri'),
('astella', 'mclaren2025', 'Andrea Stella'),
('pprodromou', 'mclaren2025', 'Peter Prodromou'),
('nhouldey', 'mclaren2025', 'Neil Houldey'),

-- 7. Williams
('aalbon', 'williams2025', 'Alexander Albon'),
('csainz', 'williams2025', 'Carlos Sainz'),
('jvowles', 'williams2025', 'James Vowles'),
('pfry', 'williams2025', 'Pat Fry'),

-- 8. Haas
('eocon', 'haas2025', 'Esteban Ocon'),
('obearman', 'haas2025', 'Oliver Bearman'),
('rhirakawa', 'haas2025', 'Ryo Hirakawa'),
('akomatsu', 'haas2025', 'Ayao Komatsu'),
('adezordo', 'haas2025', 'Andrea De Zordo'),

-- 9. Racing Bulls (VCARB)
('llawson', 'vcarb2025', 'Liam Lawson'),
('ihadjar', 'vcarb2025', 'Isack Hadjar'),
('aiwasa', 'vcarb2025', 'Ayumu Iwasa'),
('apermane', 'vcarb2025', 'Alan Permane'),
('tgoss', 'vcarb2025', 'Tim Goss'),

-- 10. Sauber / Audi
    ('nhulkenberg', 'sauber2025', 'Nico Hülkenberg'),
    ('gbortoleto', 'sauber2025', 'Gabriel Bortoleto'),
    ('jwheatley', 'sauber2025', 'Jonathan Wheatley'),
    ('jkey', 'sauber2025', 'James Key');
END
